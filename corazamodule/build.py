# python build stubs for package corazamodule
...
mod = Module('_corazamodule')
mod.add_include('"corazamodule_go.h"')
...
add_checked_function(mod, 'gomodule_RunServer', None, [param('bool', 'goRun')])

mod.generate(open('corazamodule.c', 'w'))
