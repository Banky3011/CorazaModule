/*
cgo stubs for package corazamodule.
...
// --- generated code for package: corazamodule below: ---
...
//export gomodule_RunServer
func gomodule_RunServer(goRun C.char) {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	if boolPyToGo(goRun) {
		go gomodule.RunServer()
	} else {
		gomodule.RunServer()
	}
}
